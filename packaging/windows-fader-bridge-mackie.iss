#define ProductName "Windows Fader Bridge for Mackie Control"
#define ProductVersion "1.0.0"
#define ProductExe "WindowsFaderBridge.Mackie.exe"
#define ProductRepo "https://github.com/lindelea/windows-fader-bridge-mackie"

[Setup]
AppId={{73908482-52F8-4BCD-A574-E769E73E72D7}
AppName={#ProductName}
...
OutputBaseFilename=Windows-Fader-Bridge-for-Mackie-Control-v{#ProductVersion}-Setup-x64
SetupIconFile=..\src\FaderBridge.MackieHost\assets\WindowsFaderBridge.Mackie.ico
...
[Files]
Source: "..\artifacts\mackie\Release\{#ProductExe}"; DestDir: "{app}"; Flags: ignoreversion
